...
let res2 = [30.56,44,40,50,68,77,90,111,160,200]; //TVOC初始数据
...
//
  ...
  const data = (function () {
    ...
    res1[9] =  page[page.length-1].data.HCHO_Mini;  //更新甲醛数值
    return res1;
  })();
...
res2[9] =  page[page.length-1].data.TVOC_Mini; //更新TVOC数值
    return res2;
  })();
