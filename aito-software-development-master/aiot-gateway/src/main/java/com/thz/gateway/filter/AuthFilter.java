package com.thz.gateway.filter;
...
import com.thz.gateway.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (matches(url, ignoreWhite.getWhites())) {
            ...
            if(token != null){
                try {
                    ...
                    log.error("claims error is null", e);
                }
            }
        ...
        LoginUser user = redisUtil.getCacheObject(getTokenKey(userKey), LoginUser.class);
