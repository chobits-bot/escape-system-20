...
var len=10;
var the=666;
let res1 = [420,425,430,426,430,425,420,410,411,435]; //CO2初始数据 
let res2 = [0,1,0,0,1,1,1,2,2,1]; //空气等级初始数据
...
//
  ...
  const data = (function () {
    ...
    res1[9] =  page[page.length-1].data.CO2_Light;  //更新甲醛数值
    return res1;
  })();
...
res2[9] =  page[page.length-1].data.AIRlevel_Light; //更新TVOC数值
    return res2;
  })();
