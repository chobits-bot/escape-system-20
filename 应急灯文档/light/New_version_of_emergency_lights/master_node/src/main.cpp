    ...
    else // 静态
    {
      if (scanning == 1)
      {
        ...
        case 6:
          ...
          break;
        case 7:
          dma_display->drawBitmap(0, 0, static_ban, 32, 32, myColor_left, myBLACK);
          break;
        case 8:
          dma_display->drawBitmap(0, 0, writing_toilet_1, 32, 32, myColor_left, myBLACK);
          break;
        default:
          break;
        }
    ...
    else // 静态
    {
      if (scanning == 1)
      {
        ...
        case 6:
          ...
          break;
        case 8:
          dma_display->drawBitmap(32, 0, writing_toilet_2, 32, 32, myColor_mid, myBLACK);
          break;
        default:
          break;
        }
    ...
    else // 静态
    {
      if (scanning == 1)
      {
        ...
        case 6:
          ...
          break;
        case 8:
          dma_display->drawBitmap(64, 0, writing_toilet_3, 32, 32, myColor_right, myBLACK);
          break;
        default:
          break;
        }
